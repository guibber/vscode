...
import { detectVimDentation } from '../model/vimDentation.js';
...
export class TextModel extends Disposable implements model.ITextModel, IDecorationsTreesHost {
		...
		if (options.detectIndentation) {
			...
			if (vimDentation.isVimOn) {
				return new model.TextModelResolvedOptions({
					...
					indentSize: vimDentation.softTabSize,
					insertSpaces: false,
	...
	public updateOptions(_newOpts: model.ITextModelUpdateOptions): void {
		...
		const isVimDentation = (typeof _newOpts.isVimDentation !== 'undefined') ? _newOpts.isVimDentation : this._options.isVimDentation;
